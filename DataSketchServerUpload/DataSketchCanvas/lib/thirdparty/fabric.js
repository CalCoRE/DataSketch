...
(function (global) {
    ...
    fabric.Object = fabric.util.createClass(/** @lends fabric.Object.prototype */ {
        ...
        transform: function (ctx, fromLeft) {
            if (this.group && this.canvas && this.canvas.preserveObjectStacking && this.group === this.canvas._activeGroup) {
...
(function () {
    ...
    fabric.util.object.extend(fabric.IText.prototype, /** @lends fabric.IText.prototype */ {
        ...
        _initCanvasHandlers: function (canvas) {
            ...
            debugger;
            _this._canvasITextSelectionClearedHanlder = (function () {
                fabric.IText.prototype.exitEditingOnOthers(_this);
            }).bind(this);
            _this._mouseUpITextHandler = (function () {
                if (_this._iTextInstances) {
                    _this._iTextInstances.forEach(function (obj) {
                        obj.__isMousedown = false;
                    });
                }
            }).bind(this);
            _this.on('selection:cleared', _this._canvasITextSelectionClearedHanlder);
            _this.on('object:selected', _this._canvasITextSelectionClearedHanlder);
            _this.on('mouse:up', _this._mouseUpITextHandler);
        },
