(function() {
  ...
  define(function(require) {
    ...
    return PathView = (function(superClass) {
      ...
      PathView.prototype.cloneFabric = function(_ObjectType) {
        this._ObjectType = _ObjectType;
        if (this._fabric.type === "path") {
          return new Promise((function(_this) {
            return function(resolve, reject) {
              return _this._fabric.clone(resolve);
            };
          })(this));
        } else if (this._fabric.type !== "path") {
          return this._fabric.clone();
        }
      };
