(function() {
  ...
  define(function(require) {
    var AnimationModule, Animator, ColorProperty, Globals, HM, HeightProperty, HorizontalPositionProperty, ModeSelectTool, Module, RotationProperty, ScaleProperty, ScrubBar, StampingProperty, TransparencyProperty, VerticalPositionProperty, WidthProperty;
    ...
    AnimationModule.requires = [HorizontalPositionProperty, VerticalPositionProperty, WidthProperty, HeightProperty, RotationProperty, ScaleProperty, ColorProperty, TransparencyProperty, StampingProperty];
    return AnimationModule;
  });
