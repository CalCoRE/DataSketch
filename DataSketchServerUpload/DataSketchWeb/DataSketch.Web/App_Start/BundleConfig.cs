...
namespace DataSketch.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // Autocomplete
            bundles.Add(new StyleBundle("~/Content/autocomplete").Include("~/Content/typeahead.css"));
            bundles.Add(new ScriptBundle("~/bundles/autocomplete").Include("~/Scripts/bootstrap3-typeahead.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/DataSketchApp").Include(
                        "~/DataSketchApp/cslib/thirdparty/require-2.1.18.js"));
