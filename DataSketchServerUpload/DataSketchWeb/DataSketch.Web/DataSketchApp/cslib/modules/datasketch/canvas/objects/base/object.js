  ...
  define(function(require) {
    ...
    CanvasObject = (function(superClass) {
      ...
      function CanvasObject(settings) {
        ...
        this.onclickofcanvas = bind(this.onclickofcanvas, this);
        ...
        this.setPositionofObject = bind(this.setPositionofObject, this);
      ...
      root = typeof exports !== "undefined" && exports !== null ? exports : CanvasObject;
      ...
      CanvasObject.prototype.setPositionofObject = function(left, top) {
        return this._model.set('position', {
          x: left,
          y: top
        });
      ...
      CanvasObject.prototype.onclickofcanvas = function(counter) {
        if (counter === 1) {
          return root.GridActive = 1;
        } else if (counter === 0) {
          return root.GridActive = 0;
        }
      };
      ...
      CanvasObject.prototype.cacheState = function() {
        this._model.cacheState();
        return this.enforceTransform();
      };

      CanvasObject.prototype.restoreState = function() {
        this._model.restoreState();
        return this.enforceTransform();
      };
