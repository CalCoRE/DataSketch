  ...
  define(function(require) {
    ...
    return ContextMenuView = (function(superClass) {
      ...
      ContextMenuView.prototype._render = function(model) {
        this.$el.toggleClass('objectproperty-menu-open', (model.get('display') != null) && model.get('display'));
...
//# sourceMappingURL=../../../maps/modules/datasketch/objectproperty/view.js.map
